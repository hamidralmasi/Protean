...
try:
	longFlows=flowDf[flowDf["flowsize"]>=2000000]
	longBytes=list(longFlows["flowsize"])
	longFCTs=list(longFlows["fct"])
	longGoodPut=np.sum(longBytes)*8*100/np.sum(longFCTs)/linerate
...
# print("short999fct","short99fct","short95fct","shortavgfct","shortmedfct","incast999fct","incast99fct","incast95fct","incastavgfct","incastmedfct","long999fct","long99fct","long95fct","longavgfct","longmedfct","goodput","avgTh","medTh","bufmax","buf999","buf99","buf95","avgBuf","medBuf","load", "burst", "alg", "tcp", "scenario", "nprio")
print(short999fct,short99fct,short95fct,shortavgfct,shortmedfct,incast999fct,incast99fct,incast95fct,incastavgfct,incastmedfct,long999fct,long99fct,long95fct,longavgfct,longmedfct,longGoodPut,avgTh,medTh,bufmax,buf999,buf99,buf95,avgBuf,medBuf,load,burst,alg,tcp,scenario,nprio)
